...
from config import MOSIVISUALDIM, MOSEIVISUALDIM, CMUSPEECHDIM, DEVICE, FUNNYVISUALDIM, FUNNYSPEECHDIM
...
class Dataset(Dataset):
    """
    Dataset is to make text Sentence pair or joint Sentence pair between text and other modality.
